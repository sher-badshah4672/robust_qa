...
def get_train_test_args():
    ...
    parser.add_argument('--pretrained-model-name-or-path', type=str, default='distilbert-base-uncased')
    parser.add_argument('--do-train-stage-2', action='store_true')
    parser.add_argument('--stage_2_samples', type=int, default=127)
